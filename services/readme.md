...
The simplemap can be opened in GitHub Pages by modifying the url `https://[username].github.io/pl1`. Remember to replace the `[username]` portion with your actual GitHub username. 
